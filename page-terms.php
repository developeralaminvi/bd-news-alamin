...
?>
  ...
  <section class="category-hero-banner">
    <div class="container">
      ...
      <p>'<?php echo bdk_get_site_name(); ?>' পোর্টাল ব্যবহারের সাধারণ নিয়মাবলী ও কপিরাইট শর্তাবলী।</p>
    </div>
  </section>
    ...
    <div class="single-page-layout">
      <article class="single-article-main">
        ...
        <div class="static-content-box" style="background: var(--surface-color); padding: 2rem; border-radius: var(--radius-md); border: 1px solid var(--border-color); box-shadow: var(--card-shadow); line-height: 1.8;">
          ...
          <p>
            '<?php echo bdk_get_site_name(); ?>' পোর্টালে প্রকাশিত সকল সংবাদ, নিবন্ধ, ছবি, গ্রাফিক্স, অডিও ও ভিডিও কনটেন্টের একমাত্র স্বত্বাধিকারী এই কর্তৃপক্ষ। লিখিত পূর্বানুমতি ব্যতীত কোনো ব্যক্তি, বাণিজ্যিক প্রতিষ্ঠান বা অন্য কোনো মিডিয়া আমাদের কোনো কনটেন্ট আংশিক বা সম্পূর্ণরূপে কপি, পুনর্মুদ্রণ, প্রচার বা অন্য কোনো ওয়েবসাইটে প্রকাশ করতে পারবে না। অননুমোদিত কপিরাইট লঙ্ঘনের ক্ষেত্রে বাংলাদেশের কপিরাইট আইন ও তথ্যপ্রযুক্তি আইন অনুযায়ী আইনগত ব্যবস্থা গ্রহণ করা হবে।
          </p>
