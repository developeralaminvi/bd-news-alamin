...
function bdk_get_default_theme_ad_slots() {
	return array(
		'bdk_header_ad' => array(
			'title'          => 'হেডার ব্যানার বিজ্ঞাপন (728x90)',
			'enable'         => true,
			'rotation_mode'  => 'timer',
			'rotate_seconds' => 5,
			'banners'        => array(),
		...
		'bdk_mid_ad' => array(
			'title'          => 'হোমপেজ মিডল ব্যানার (970x90)',
			'enable'         => true,
		...
		'bdk_archive_ad' => array(
			'title'          => 'আর্কাইভ ও ক্যাটাগরি ব্যানার (728x90)',
			'enable'         => true,
			'rotation_mode'  => 'reload',
			'rotate_seconds' => 5,
			'banners'        => array(),
		...
		'bdk_single_top_ad' => array(
			'title'          => 'সিঙ্গেল পোস্ট টপ ব্যানার (728x90)',
			'enable'         => true,
			'rotation_mode'  => 'timer',
			'rotate_seconds' => 5,
			'banners'        => array(),
		...
		'bdk_single_mid_ad' => array(
			'title'          => 'সিঙ্গেল পোস্ট মিডল ব্যানার (728x90)',
			'enable'         => true,
			'rotation_mode'  => 'timer',
			'rotate_seconds' => 5,
			'banners'        => array(),
		...
		'bdk_single_bot_ad' => array(
			'title'          => 'সিঙ্গেল পোস্ট বটম ব্যানার (728x90)',
			'enable'         => true,
			'rotation_mode'  => 'reload',
			'rotate_seconds' => 5,
			'banners'        => array(),
		...
		'bdk_sidebar_ad' => array(
			'title'          => 'সাইডবার ব্যানার (300x250 / 300x600)',
			'enable'         => true,
			'rotation_mode'  => 'timer',
			'rotate_seconds' => 5,
			'banners'        => array(),
