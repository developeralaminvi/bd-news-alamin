		...
		<div class="container" style="position: relative; z-index: 2;">
			...
			<div style="max-width: 800px;">
				...
				<p style="font-size: 1.05rem; opacity: 0.95; line-height: 1.7; margin-bottom: 1.5rem; max-width: 720px;">
					<?php echo bdk_get_site_name(); ?> অনলাইন পোর্টালে বিজ্ঞাপন দিয়ে আপনার পণ্য, প্রতিষ্ঠান ও সেবাকে সহজেই পরিচিত করুন দেশের ৬৪ জেলার লক্ষাধিক টার্গেটেড পাঠকের কাছে।
				</p>
